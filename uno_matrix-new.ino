...
/*
 * TAMPILAN HARI DAN BULAN BAHASA INDONESIA
 * TANGGAL DAN JAM TAMPIL GANTIAN OTOMATIS TANPA DITEKAN TOMBOL
 */
// Setup LED Matrix
...
void display_date()
{
  ...
  char monthnames[12][9] = {
    "Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "August", "Sept", "October", "November", "December"
  };
  ...
  puttinychar(10 + offset, 1, buffer[0]);
  ...
  if (date > 9) {
    ...
    offset = 5; //offset to centre text if 4 chars
  }
...
//char budek[3];
  ...
  puttinychar( 11, 1, '0');
   ...
   puttinychar(18, 1, buffer[0]);
  puttinychar( 24, 1, buffer[1]);
